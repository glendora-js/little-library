...
exports.getGenreByLibraryId = function(req, res) {
    res.status(genreDao.getGenreByLibraryId(req.query.libraryId)); //TODO: needs to be implemented
    res.end();
};
...
exports.getBooksByLibraryId = function(req, res) {
    res.json({"isbn": bookDao.getBooksByLibraryId(req.query.libraryId, req.query.milesRadius)}); //TODO: needs to be implemented
    res.end();
};
...
exports.getGenreByDistance = function(req, res) {
    return genreDao.getGenreByDistance(req.query.loc, req.query.milesRadius, res); //TODO: needs to be implemented
    res.end();
};
