...
var FilterBox = React.createClass({displayName: "FilterBox",
  render :  function(){
    return (
      React.createElement("div", {className: "well filters"}, 
        React.createElement("div", {className: "row"}, 
          React.createElement("div", {className: "col-sm-4"}, 
            React.createElement("div", {className: "form-group"}, 
              React.createElement("label", null, "City"), 
              React.createElement("input", {type: "text", name: "city", value: "", className: "form-control", placeholder: "Glendora", autoFocus: true, onKeyDown: this.props.handleKeyDown})
            ), 
            React.createElement("div", {className: "form-group"}, 
              React.createElement("label", null, "Zipcode"), 
              React.createElement("input", {type: "text", name: "zipcode", value: "", className: "form-control", placeholder: "91740", autoFocus: true, onKeyDown: this.props.handleKeyDown})
            )
          ), 
          React.createElement("div", {className: "col-sm-4"}, 
            React.createElement("div", {className: "form-group"}, 
              React.createElement("label", null, "Steward"), 
              React.createElement("input", {type: "text", name: "steward", value: "", className: "form-control", placeholder: "John Doe", autoFocus: true, onKeyDown: this.props.handleKeyDown})
            ), 
            React.createElement("div", {className: "form-group"}, 
              React.createElement("label", null, "Email"), 
              React.createElement("input", {type: "text", name: "email", value: "", className: "form-control", placeholder: "email@email.com", autoFocus: true, onKeyDown: this.props.handleKeyDown})
            )
          ), 
          React.createElement("div", {className: "col-sm-4"}, 
            React.createElement("div", {className: "form-group"}, 
              ...
              React.createElement("div", {className: "dropdown"}, 
                React.createElement("button", {className: "btn btn-default dropdown-toggle", type: "button", id: "filterStatus", "data-toggle": "dropdown", "aria-haspopup": "true", "aria-expanded": "true"}, 
                  this.props.filter.status
                ), 
                React.createElement("ul", {className: "dropdown-menu", "aria-labelledby": "filterStatus"}, 
                  React.createElement("li", null, React.createElement("a", {href: "#", className: this.props.filter.status == "all" ? 'hide' : '', onClick: this.props.filterLibs}, "all")), 
                  React.createElement("li", null, React.createElement("a", {href: "#", className: this.props.filter.status == "enabled" ? 'hide' : '', onClick: this.props.filterLibs}, "enabled")), 
                  React.createElement("li", null, React.createElement("a", {href: "#", className: this.props.filter.status == "disabled" ? 'hide' : '', onClick: this.props.filterLibs}, "disabled"))
                )
              )
            )
          )
...
var LibItem = React.createClass({displayName: "LibItem",
  ...
  render : function(){
    return (
      React.createElement("tr", null, 
        React.createElement("td", null, " ", this.props.lib.name, " "), 
        React.createElement("td", null, " ", this.formatStory(this.props.lib.story), " "), 
        React.createElement("td", null, " ", this.props.lib.street, " "), 
        React.createElement("td", null, " ", this.props.lib.city, " "), 
        React.createElement("td", null, " ", this.props.lib.state, " "), 
        React.createElement("td", null, " ", this.props.lib.zip, " "), 
        React.createElement("td", null, " ", this.props.lib.email, " "), 
        React.createElement("td", null, " ", this.props.lib.steward_name, " "), 
        React.createElement("td", null, 
          React.createElement("div", {className: "btn-group"}, 
            React.createElement("button", {type: "button", className: "btn btn-default dropdown-toggle", "data-toggle": "dropdown", ariahaspopup: "true", "aria-expanded": "false"}, 
              this.showStatus(this.props.lib.status)
            ), 
              React.createElement("ul", {className: "dropdown-menu"}, 
                React.createElement("li", null, React.createElement("a", {href: "#", className: !this.props.lib.status ? 'hide' : '', onClick: this.props.filterLibs}, "disable")), 
                React.createElement("li", null, React.createElement("a", {href: "#", className: this.props.lib.status ? 'hide' : '', onClick: this.props.filterLibs}, "enable"))
              )
          )
        ), 
        React.createElement("td", null, 
          ...
          React.createElement("button", {style: {"marginLeft":"4px"}, className: "btn btn-danger", onClick: ""}, 
...
var LibsApp = React.createClass({displayName: "LibsApp",
  getInitialState : function(){
    return {
      filter : { 
        city : '',
...
ReactDOM.render(
  React.createElement(LibsApp, {libs: libs}), 
  document.getElementById('libraries')
);

},{"./libs-app.jsx":159,"react":158,"react-dom":2}]},{},[160]);
